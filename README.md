...
**little facts** - Every Bug is a plot twist waiting to be resolved.
...
- Git, GitHub, Linux, Jupyter, Postman, Vercel, Render, Railway  
- REST APIs, JWT, MVC, OOPs, System Design

## 🚀 Projects
- 🧥 ReWear – Sustainable Fashion Swapping Platform  
   [Live Demo](https://rewear-odoo-lovat.vercel.app) | [Repo](https://github.com/Rahul-Suthar/Rewear_Odoo) 

- 🧪 Flask-wiz – Full-Stack Flask App Generator  
[Repo](https://github.com/rahul-suthar/flask-wiz)

- FlockGuard - AI-powered flock farm monitor  
  [Repo](https://github.com/rahul-suthar/FlockGuard) (WIP)
